...
<td align="center" style="background-color:#004c93; color:#fff;"><b>User Name</b></td>
<td align="center" style="background-color:#004c93; color:#fff;"><b>User Type</b></td>
<td align="center" style="background-color:#004c93; color:#fff;"><b></b></td>
...
<td align="center" ><form align="center" name="actionForm" method ="GET" action="DeleteUser">

<input type="hidden" name="username" value="<%=username %>">
<input type="hidden" name="userType" value="<%=userType %>">
<button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Delete User</button> 
</form> 
