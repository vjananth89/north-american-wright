...
<li><a href="#">|</a></li>
    ...
    <a style="color:#00008B;" href="javascript:document.submitForm.submit()"><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span> View Reviews</a></button></form></li>
      ...
      <!-- Main component for a primary marketing message or call to action -->
 	 	...
 	 	<div class="jumbotron">
 	 	<h2 style="font: Helvetica;" align="center">Great! Cakes have been added to our database!</h2>
 	 	<br><br>
        <p align="center">Cakes will be shown in user search results immediately!</p>
