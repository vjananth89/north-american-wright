...
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Select the Quantity and Checkout</b></td>
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Delete From Cart</b></td>
...
<td align="center" ><form name="submitForm" method="GET" action="NewFile.jsp">
...
<input type="hidden" name="cost" value="<%=cost %>">
  <script
    ...
    data-key="pk_test_rgHYNYjOGFt0m6mJdQQrBTvq"
    data-image="https://s3-us-west-2.amazonaws.com/ananth89/strawberry3"
    data-name="UAlbany Cake Shop"
    data-description="Type your Payment Information"
    data-allow-remember-me="false"
    data-amount="">
  </script>
<!--  <input type="submit" style="margin-top:10px; height:50px;" value="Add to Cart"> -->
</td></form>

<td align="center"><form name="submitForm5" method="GET" action="RemoveCart">
...
<input type="submit" class="btn btn-danger" value="Delete from Cart"> </td></form>
</tr>
<%}
}%>
