...
/**
 * Servlet implementation class ViewOrdersSeller
 */
@WebServlet("/ViewOrdersSeller")
public class ViewOrdersSeller extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private ServletConfig config;

	  //Setting JSP page

	  String page="ViewOrdersSeller.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
		 ...
		 // connection = DriverManager.getConnection(connectionURL, "root", "root"); 
		  ...
		  String sql = "select * from ualbcake.orderhistory where seller='"+sessionUser+"'";
