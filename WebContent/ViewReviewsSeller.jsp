...
<title>View Seller Reviews</title>
...
<li><a href="#">|</a></li>
 ...
 <!-- /container -->    
   ...
   <div align="center" class="panel panel-default" style="width:1150px;">
    <h2 align="center">Review by Users for Cakes</h2>
...
if(data.size()==0){
	%>
		<h3 align="center">No reviews at this time!</h3>
	<% } else
	{ %>
	<tr>
...
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Cake Id</b></td>
...
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Comment</b></td>
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Username</b></td>
...
<td align="center" ><% String conf_id= (String)itr.next();%><%=conf_id%></td>
<td align="center" ><% String comment= (String)itr.next();%><%=comment%></td>
<td align="center" ><% String username= (String)itr.next();%><%=username%></code></td>
