...
<title>View Orders Seller</title>
...
<li><a href="#">|</a></li>
 ...
 <!-- /container -->    
   ...
   <div align="center" class="panel panel-default" style="width:1150px;">
    <h2 align="center">Your Order List</h2>
...
if(data.size()==0){
	%>
		<h2 align="center">Customers have not purchased anything from you at the moment!</h2>
	<% } else
	{ %>
	<tr>
...
<td text-align="center" style="background-color:#004c93; color:#fff;"><b>Current Status</b></td>
<td text-align="center" style="background-color:#004c93; color:#fff;"><b></b></td>
...
<td align="center" ><form align="center" name="actionForm" method ="GET" action="UpdateOrderStatus">
        <select name="status" >
...
<button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-refresh"></span> Update Status</button> 
</form> 
