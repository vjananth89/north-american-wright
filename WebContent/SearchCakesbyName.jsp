...
<title>Search Cakes Buyer</title>
...
<li><a href="#">|</a></li>
      ...
      <!-- Main component for a primary marketing message or call to action -->
        ...
        <p align="center">Our very accurate  SearchCakes &#8482; feature helps you search for just about any keyword and
        related to our cakes and helps you find information related to them!</p>
        <p align="center"> <a class="btn btn-lg btn-primary" href="#search" role="button">Search!</a>
        </p>
      </div>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="	
https://s3-us-west-2.amazonaws.com/ananth89/Buccellato" alt="...">
      <div class="caption">
        <h3>Buccellato</h3>
        <p>We assure you that our Buccellato cakes are the best! Just search for them when you use our "Search Cakes" &#8482; feature</p>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="	
https://s3-us-west-2.amazonaws.com/ananth89/Angel" alt="...">
      <div class="caption">
        <h3>Angel</h3>
        <p>We think you should try our Angel Cakes too! Just search for Angel when you use our "Search Cakes" &#8482; feature</p>
    ...
    <div class="thumbnail">
      <img src="	
https://s3-us-west-2.amazonaws.com/ananth89/cardpayments" alt="...">
      <div class="caption">
        <h3>Convenient!</h3>
        <p>We have the most convenient and safest payment systems you can ever come across while shopping. Try our payment system! It really is the best in the world</a></p>
      </div>
    </div>
  </div>
  </div>
...
<div id="search">
    ...
    <form name="actionForm" action="SearchCakes"  method ="GET" onsubmit="required()" >
        <input type="search" name="cakeName" value="" placeholder="Enter any cake name/cost/cakeId/seller" />
...
<!-- Main component for a primary marketing message or call to action -->
      ...
      <h1>UAlbany Cake Shop is a great place to buy cakes. We make sure you have the best cake shopping experience ever!</h1>
       <p> <a class="btn btn-success" href="#search" role="button">Start Searching!</a>
       </div>
