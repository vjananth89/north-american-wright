...
<html lang="en">
  ...
  <![endif]--><!-- Fav and touch icons -->
	...
	<link href="https://s3-us-west-2.amazonaws.com/ananth89/freelancer.css" rel="stylesheet"> 
    	...
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	<div class="panel-heading">
			    	<b class="panel-title"><b></b>Welcome to UAlbany Cake Shop</b>
			 	</div>
			  	<div class="panel-body">
			    	<form class="form" name="actionForm" action="LoginServlet" method ="GET" >
                    <fieldset>
			            ...
			            <a href='UsernameCheck.jsp' class="btn btn-lg btn-success btn-block" >Not a Member? Register</a>
			    	</fieldset>
			      	</form>
			    </div>
			</div>
...
<style>
    body{
  <!--  background: url(https://s3-us-west-2.amazonaws.com/ananth89/ChocolateExtremeCake.png); -->
	background-color: #fff;
 <!--   background: url(https://s3-us-west-2.amazonaws.com/ananth89/ChocolateExtremeCake.png),url(https://s3-us-west-2.amazonaws.com/ananth89/greybackground.png); -->   
}
...
backgroundPosition: ""+ parseInt(event.pageX/8) + "px "+parseInt(event.pageY/'12')+"px, "+parseInt(event.pageX/'15')+"px "+parseInt(event.pageY/'15')+"px, "+parseInt(event.pageX/'30')+"px "+parseInt(event.pageY/'30')+"px"
      ...
      <footer class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="footer-col col-md-4">
                        <h3>Location</h3>
                        <p>1400 Washington Ave<br>Albany, NY 12222</p>
                    </div>
                    <div class="footer-col col-md-4">
        ...
        <div class="col-lg-12 text-center v-center" style="font-size:39pt;">
          <i class="icon-google-plus"></i> <i class="icon-facebook"></i>  <i class="icon-twitter"></i> <i class="icon-github"></i> <i class="icon-pinterest"></i>
        </div>
                    ...
                    <div class="footer-col col-md-4">
                        <h3>UAlbany Cake Shop</h3>
                        <p>This is Lab 3 Team 4's Term Project for ICSI 518 Software Engineering</p>
                    </div>
                </div>
            </div>
        </div>
